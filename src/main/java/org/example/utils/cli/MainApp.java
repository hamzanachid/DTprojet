package org.example.utils.cli;

import org.example.entities.Utilisateur;
import org.example.utils.CheckAccess;
...
import static org.example.utils.cli.helpers.HandleElementModule.handleElementModule;
import static org.example.utils.cli.helpers.HandleEtudiants.handleEtudiants;
import static org.example.utils.cli.helpers.HandleFilieres.handleFilieres;
import static org.example.utils.cli.helpers.HandleModaliteEvaluation.handleModaliteEvaluation;
import static org.example.utils.cli.helpers.HandleModules.handleModules;
 import static org.example.utils.cli.helpers.HandleProfesseurs.handleProfessors;
import static org.example.utils.cli.note.HandleNotes.handleNotes;
...
public class MainApp {
    ...
    private static void handleLogin() {
        ...
        if (utilisateur != null) {
            ...
            CheckAccess.setCurrentUser(utilisateur.getRole());
            isLoggedIn = true;
    ...
    private static boolean handleMenuChoice(String choice) {
        if ("ADMIN".equals(currentRole)) {
            ...
            switch (choice) { 
                case "1": handleNotes(currentUser); break;
