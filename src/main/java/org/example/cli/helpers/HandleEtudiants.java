...
public class HandleEtudiants {
    ...
    private static void deleteEtudiant() {
        ...
        String matricule = prompt("Enter Matricule");
    ...
    private static void updateEtudiant() {
        ...
        Long Id = Long.valueOf(prompt("Enter Etudiant id to be updated"));
        String newFirstName = prompt("Enter new first name");
        String lastLastName = prompt("Enter new last name");
        String matricule = prompt("new matriculer?");
        Etudiant oldEtudiant = etudiantService.getById(Id);
